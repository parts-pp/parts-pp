        ...
        if not inv_file:
            ...
            try:
                msg_private = (
                    ...
                    + "اختر أحد الخيارين وأرسله هنا في الخاص:\n"
                    + "1) <b>فاتورة المتجر</b> (PDF أو صورة)\n"
                    + "2) <b>رابط دفع إلكتروني</b> (نص الرابط فقط) — إذا المتجر لا يصدر فاتورة قبل السداد\n"
                    + "\n✅ البوت يقبل: صورة / PDF / رابط دفع.\n"
                    + "بعدها ننتظر من العميل إرسال <b>إيصال السداد</b> لإكمال الشحن.\n"
                    + "ℹ️ إذا كانت بيانات الدفع (IBAN / STC Pay) غير مضافة في لوحة التاجر، أضفها لاحقاً لتظهر للعميل تلقائياً."
                )
                await context.bot.send_message(
                    chat_id=actor_id,
                    text=msg_private,
