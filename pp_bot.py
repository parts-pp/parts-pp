...
def more_kb():
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("✅ انهاء وارسال للدفع 01", callback_data="pp_more_no")],
...
def photo_prompt_kb():
    ...
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("✅ انهاء وارسال للدفع 02", callback_data="pp_more_no")],
        [InlineKeyboardButton("✖️ الغاء الطلب", callback_data="pp_cancel")],
    ])
...
def prepay_notes_kb():
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("⏭️ تخطي والانتقال للدفع 03", callback_data="pp_prepay_notes_skip")],
        [InlineKeyboardButton("✖️ الغاء الطلب", callback_data="pp_cancel")],
    ])
