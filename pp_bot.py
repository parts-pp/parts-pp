...
async def send_trader_ledger_pdf(
    ...
    # - ✅ الجديد: الفاصل بين "القيمة" و"الكلمة" داخل كل زوج شبه غير مرئي
    # =========================
    LRE = "\u202A"
    PDF = "\u202C"
    ...
    # ✅ فاصل داخلي شبه غير مرئي (بين القيمة والكلمة داخل كل زوج)
    SEP_COL = _with_alpha(C_BORDER, 0.10)
    ...
    badges.setStyle(TableStyle([
        ...
        # ✅ اجعل الفاصل بين (0|1) و (2|3) و (4|5) شبه غير مرئي
        ("LINEAFTER", (0, 0), (0, 0), 0.10, SEP_COL),
        ("LINEAFTER", (2, 0), (2, 0), 0.10, SEP_COL),
        ("LINEAFTER", (4, 0), (4, 0), 0.10, SEP_COL),
    ]))
    story.append(badges)
